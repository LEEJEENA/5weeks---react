...
import {  __addComment, __deleteComment,  __getComment } from "../redux/modules/commentSlice";
import styled from "styled-components";
// import { STCommentBtn } from "./custombutton/styles";
  ...
  <>
    ...
    <StCommentBox >
      ...
      <StcommentInput
        ...
        maxLength={100}
      />
        <STCommentBtn onClick={onAddCommentButtonHandler}>
            추가하기
        </STCommentBtn>
    </StCommentBox>
            ...
            comments.map((item) => {
                ...
                if (item.todoId == id){
                    ...
                    <StCommentList key={item.id}>
                        ...
                        <STCommentBtn onClick={() => onDeleteButton(item.id)}>삭제하기</STCommentBtn>
                    </StCommentList>
                ) 
                }
