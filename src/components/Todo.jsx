...
// import { STNavBtn, STTodoDoneBtn, STDoneBtn } from "./custombutton/styles";
        ...
        <STPageBtn>
          <STTodoBottom key={todo.id}>
            ...
            <div>{edit ? (
                ...
                {/* 버튼 일렬로 정렬 */}
                <STTodoEditBtn>
                  <STTodoDoneBtn onClick={onClickUdapte}>수정완료</STTodoDoneBtn>
                  <STTodoDoneBtn onClick={()=> btnModiCancle()}>수정취소</STTodoDoneBtn>
                </STTodoEditBtn>
                
                </> ) : (
                <>
                <div>{todo.content}</div>
                <STDoneBtn onClick={()=>{toggleEdit()}} >수정 </STDoneBtn>
                </>
